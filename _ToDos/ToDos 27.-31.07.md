...
- EnBW Einarbeiten 
  ...
  - [-] Benny fragen, ob er einen SM besorgen kann für DBB Team
    - Thema: Spannende Sachen werden nur von älteren Teammitgliedern genommen (z.B. Tobias Haaß)
    - [-] mit Fabian sprechen

- DM
  - APM Sergej
    - [X] Trainer finden
    - [X] Termin Auftragsklärung Trainer - Team Sergej
    - [X] Mit Benny klären und Termin ausmachen mit dem Kunden
  - CN Produkt Analyse (Metzger / Birkholz)
    - [X] Nach angebot schauen
    - [ ] markus fragen
  - [ ] Rückmeldung finanzen.net?
  - [ ] Nächste Schritte Kundenteam
  - [ ] DM KTT planen
  - [ ] Vorbereitung Fr. dm Kundenteam Strategie
